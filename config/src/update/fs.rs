    ...
    io::Error: From<F::Error>,
{
    ...
    async fn update_config_item_gateway(&self, gateway_name: &str, gateway: &crate::model::SgGateway) -> Result<(), Self::Error> {
    ...
    async fn update_config_item_route(&self, gateway_name: &str, route_name: &str, route: &crate::model::SgHttpRoute) -> Result<(), Self::Error> {
