...
```bash
cd /Users/yiye/projectSpace/[REDACTED]_project/spacegate
...
Collector 配置来自 [otel-stack.yaml](/Users/yiye/projectSpace/[REDACTED]_project/spacegate/deploy/k8s/test-spacegate/otel-stack.yaml)，ClickHouse exporter 使用：
