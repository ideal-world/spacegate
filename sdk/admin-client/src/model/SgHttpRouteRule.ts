...
import type { SgBalancePolicy } from "./SgBalancePolicy";
import type { SgHttpRouteMatch } from "./SgHttpRouteMatch";
import type { TimeoutMode } from "./TimeoutMode";

export type SgHttpRouteRule<P = PluginBinding> = {
/**
 ...
 */
timeout_ms: number | null, timeout_mode: TimeoutMode | null, balance_policy: SgBalancePolicy | null, };