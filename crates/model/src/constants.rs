...
pub const GATEWAY_ANNOTATION_REDIS_POOL_MAX_SIZE: &str = "spacegate.io/redis-pool-max-size";
pub const GATEWAY_ANNOTATION_REDIS_POOL_WAIT_TIMEOUT_MS: &str = "spacegate.io/redis-pool-wait-timeout-ms";
pub const GATEWAY_ANNOTATION_REDIS_POOL_CREATE_TIMEOUT_MS: &str = "spacegate.io/redis-pool-create-timeout-ms";
pub const GATEWAY_ANNOTATION_REDIS_POOL_RECYCLE_TIMEOUT_MS: &str = "spacegate.io/redis-pool-recycle-timeout-ms";
