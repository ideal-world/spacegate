...
#[cfg_attr(feature = "schema", schemars(example = "redis_count_schema_example", title = "Redis计数插件配置"))]
...
/// Provides a complete Redis count configuration for the generated plugin example.
#[cfg(feature = "schema")]
fn redis_count_schema_example() -> serde_json::Value {
    serde_json::json!({"id": "demo-count", "header": "authorization"})
}
